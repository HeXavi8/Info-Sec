...
public class RSApem {
    ...
    public static RSAPublicKey getPublicKeyFromPem(String path) throws Exception {
        BufferedReader br = new BufferedReader(new FileReader(SystemConfig.setAndGetProjectPath()+path));
     ...
     *
     */
    public static RSAPrivateKey getPrivateKeyFromPem(String path) throws Exception {
        BufferedReader br = new BufferedReader(new FileReader(SystemConfig.setAndGetProjectPath()+path));
        String s = br.readLine();
        String str = "";
        s=br.readLine();
